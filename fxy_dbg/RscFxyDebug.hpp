...
class RscFxyDebug
{
	...
	class Controls
	{
		...
		class EditorArgsBackground : RscFxyDebugText
		{
			x = 4.5 * FXY_DBG_GUI_GRID_W + FXY_DBG_GUI_GRID_X;
			y = 23 * FXY_DBG_GUI_GRID_H + FXY_DBG_GUI_GRID_Y;
			w = 31 * FXY_DBG_GUI_GRID_W;
		...
		class EditorArgs : RscFxyDebugEdit
		{
			idc = IDC_FXY_DBG_EDITOR_ARGS;
			x = 4.5 * FXY_DBG_GUI_GRID_W + FXY_DBG_GUI_GRID_X;
			y = 23 * FXY_DBG_GUI_GRID_H + FXY_DBG_GUI_GRID_Y;
			w = 31 * FXY_DBG_GUI_GRID_W;
			h = 1 * FXY_DBG_GUI_GRID_H;
